...
public class GetNextCharLearningInQueueHandler : IRequestHandler<GetNextToReviewInQueueQuery, CharacterLearningResponseBase?>
{
    ...
    public async Task<CharacterLearningResponseBase?> Handle(GetNextToReviewInQueueQuery request, CancellationToken cancellationToken)
    {
