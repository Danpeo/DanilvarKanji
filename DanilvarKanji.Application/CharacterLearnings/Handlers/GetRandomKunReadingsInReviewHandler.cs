...
public class GetRandomKunReadingsInReviewHandler : IRequestHandler<GetRandomKunReadingsInReviewQuery, (List<string>
    random, string correct)>
{
    ...
    public GetRandomKunReadingsInReviewHandler(ICharacterLearningRepository charLearningRepository,
    ...
    public async Task<(List<string> random, string correct)> Handle(GetRandomKunReadingsInReviewQuery request,
        CancellationToken cancellationToken)
    {
        string? randomKunyomiFromCharacter =
            _characterRepository.GetRandomKunyomiFromCharacter(request.CharacterId);
    ...
    private async Task<(List<string> random, string correct)> GetFromReviewAndLearnQueueAsync(
        GetRandomKunReadingsInReviewQuery request, int characterQty,
        IEnumerable<string?> charLearningsFromReview, string? randomMeaningFromReviewedChar)
    {
        var charLearningsToLearn =
            await _characterRepository.GetRandomKunReadingsInLearnQueueAsync(request.AppUser, characterQty);
