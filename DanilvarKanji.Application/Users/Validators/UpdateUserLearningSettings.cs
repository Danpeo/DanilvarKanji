...
public class UpdateUserLearningSettings : ValidatorBase<UpdateUserLearningSettingsCommand>
{
    public UpdateUserLearningSettings()
    {
        RuleFor(x => x.Email)
            .NotEmpty()
        ...
        RuleFor(x => x.LearningSettings).NotNull().WithMessage("Learning Settings should not be NULL.");
