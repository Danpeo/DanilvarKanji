...
public class UpdateUserXpHandler: IRequestHandler<UpdateUserXpCommand, Result<string>>
{
    ...
    public UpdateUserXpHandler(IUserRepository userRepository, IUnitOfWork unitOfWork, ILogger<UpdateUserXpHandler> logger)
    {
    ...
    public async Task<Result<string>> Handle(UpdateUserXpCommand request, CancellationToken cancellationToken)
    {
