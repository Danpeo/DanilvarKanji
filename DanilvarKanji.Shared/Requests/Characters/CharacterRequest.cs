    ...
    */
    ...
    public void Init()
    {
        ...
        Mnemonics.Add(
            ...
            {
                Value =
                    "По всей земле рассыпан рис. Это заставит Хищника подойти ведь он любть kome (рис).",
        ...
        Kunyomis.Add(new Kunyomi { JapaneseWriting = "く。る" });

        Onyomis.Add(new Onyomi { JapaneseWriting = "ラ" });
    }
}