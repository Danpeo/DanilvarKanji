...
{
    /// <inheritdoc />
    public partial class AddStringIdTest : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LearnedCount = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    JapaneseWriting = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    Furigana = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Romaji = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    FullJapanese = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PartOfSpeach = table.Column<int>(type: "int", nullable: false),
                    CharacterId = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
