...
public class Dom
{
    ...
    public async Task AddClassesToElementForTimeAsync(
        string? elementId,
    ...
    public async Task ApplyThemeAsync(string css)
    {
        await _jsRuntime.InvokeVoidAsync("applyTheme", css);
    }

    public async Task RemoveThemeAsync(string css)
    {
        await _jsRuntime.InvokeVoidAsync("removeTheme", css);
    }

    public async Task RemoveAllThemesAsync()
    {
        await _jsRuntime.InvokeVoidAsync("removeAllThemes");
    }
}