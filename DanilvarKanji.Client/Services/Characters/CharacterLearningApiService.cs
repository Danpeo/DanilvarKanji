...
public class CharacterLearningApiService : ICharacterLearningApiService
{
    ...
    public async Task<List<CharacterLearningResponseBase>?> ListCompletelyLearnedAsync(int pageNumber = 0,
        int pageSize = 0)
    {
        string uri = $"api/CharacterLearnings/CompletelyLearned?PageNumber={pageNumber}&PageSize={pageSize}";
