...
namespace DanilvarKanji.Infrastructure.Migrations
{
    ...
    [Migration("20240329092830_RemoveImageAndChangeRolePropInAppUser")]
    partial class RemoveImageAndChangeRolePropInAppUser
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DanilvarKanji.Shared.Domain.Entities.AppUserRole", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("DanilvarKanji.Shared.Domain.Entities.AppUser", b =>
                {
                    b.HasOne("DanilvarKanji.Shared.Domain.Entities.AppUserRole", "AppUserRole")
                        .WithMany()
