...
namespace DanilvarKanji.Infrastructure.Migrations
{
  ...
  public partial class RemoveFrontEntity : Migration
  {
    ...
    {
      migrationBuilder.DropForeignKey(name: "FK_Flashcards_Front_FrontId", table: "Flashcards");

      migrationBuilder.DropTable(name: "Front");

      migrationBuilder.DropIndex(name: "IX_Flashcards_FrontId", table: "Flashcards");

      migrationBuilder.DropColumn(name: "FrontId", table: "Flashcards");
    ...
    {
      migrationBuilder.DropColumn(name: "Main", table: "Flashcards");

      migrationBuilder.DropColumn(name: "Sub", table: "Flashcards");
